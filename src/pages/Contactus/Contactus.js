...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:mayur0811p@gmail.com?subject=Sample&body=${body}`)
    }
    return (
        ...
        <div className="headerContact">
            <Image className="imageContact" src="https://st.depositphotos.com/1265075/3330/i/450/depositphotos_33303183-stock-photo-web-contact-us-icons-on.jpg" alt="contactImage" objectFit="cover"/>
            <div className="text">
                <h2>Contact</h2>  
            </div>
